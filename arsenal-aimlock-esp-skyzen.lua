--[[
    ARSENAL AIM LOCK + ESP SCRIPT (SKYZEN VERSION)
    ================================================
    Converted from Rayfield to SkyZen UI Library
    Features:
...
-- AIM LOCK SECTION
local AimSection = MainTab:CreateSection("🎯 AIM LOCK")
...
-- ESP SECTION
local ESPSection = MainTab:CreateSection("👁️ ESP")
...
print("✅ Arsenal Lite (SkyZen) Loaded!")
